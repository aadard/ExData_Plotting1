...
par(mfrow = c(2, 2))
with(dat,{
plot(dat$Date2,dat$Global_active_power,
     type = "l",
     ylab = "Global Active Power",
     xlab ="")
plot(dat$Date2,dat$Voltage,
     type = "l",
     ylab = "Voltage",
     xlab = "datetime")
plot(dat$Date2,dat$Sub_metering_1,
     ...
     xlab = "")
lines(dat$Date2,as.numeric(dat$Sub_metering_2),type = "l",col  = "red")
lines(dat$Date2,dat$Sub_metering_3,type = "l",col  = "blue")
legend("topright", lty = 1, 
       col = c("black","red","blue"), 
       legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
plot(dat$Date2,dat$Global_reactive_power,
     type = "l",
     ylab = "Voltage",
     xlab = "datetime")
